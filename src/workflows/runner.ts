...
function workflowPrompt(request: WorkflowRequest): string {
  switch (request.kind) {
    case "COMPANY_DISCOVERY":
      return [
        "Read AGENTS.md, docs/ICP.md, docs/PRODUCT.md, and prompts/company-discovery.md.",
        ...
        "Use the target segments, channel partners, research channels, and ranking rubric in docs/ICP.md and prompts/company-discovery.md. Prefer seed-to-Series-A teams with fewer than 20 engineers, a live product, and Flutter, React web, or React Native; include qualified mobile agencies as channel partners.",
        "Treat public jobs and community complaints only as leads: verify the company, affiliation, domain, product, date, and fit before persistence, and never contact or reply during discovery.",
    ...
    case "EMAIL_GENERATION":
      return [
        "Read AGENTS.md, docs/PRODUCT.md, docs/EMAIL_RULES.md, and prompts/email-generation.md.",
